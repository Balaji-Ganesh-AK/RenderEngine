...
namespace KREngine
{
	...
	private:
		...
		glm::mat4 WorldProjection = glm::ortho( -2.0f, 2.0f, -1.5f, 1.5f, -1.0f, 1.0f );
		...
		float pos [8 * 24] = {
			...
			/** 0 */		-0.5f,-0.5f,-0.5f,		1.0f, 1.0f, 1.0f,	0.0f, 0.0f,
			/** 1 */		0.5f,-0.5f,	-0.5f,		1.0f, 1.0f, 1.0f,	1.0f, 0.0f,
			/** 2 */		0.5f,0.5f,	-0.5f,		1.0f, 1.0f, 1.0f,	1.0f, 1.0f,
			/** 3 */		-0.5f,0.5f,	-0.5f,		1.0f, 1.0f, 1.0f,	0.0f, 1.0f,

			/** 4 */		-0.5f,-0.5f,0.5f,		1.0f, 1.0f, 1.0f,	0.0f, 0.0f,
			/** 5 */		0.5f,-0.5f,	0.5f,		1.0f, 1.0f, 1.0f,	1.0f, 0.0f,
			/** 6 */		-0.5f,0.5f,	0.5f,		1.0f, 1.0f, 1.0f,	0.0f, 1.0f,
			/** 7 */		0.5f,0.5f,	0.5f,		1.0f, 1.0f, 1.0f,	1.0f, 1.0f,

			/** 8 */		-0.5f,0.5f,	-0.5f,		1.0f, 1.0f, 1.0f,	0.0f, 0.0f,
			/** 9 */		0.5f,0.5f,	-0.5f,		1.0f, 1.0f, 1.0f,	1.0f, 0.0f,
			/** 10 */		0.5f,0.5f,	0.5f,		1.0f, 1.0f, 1.0f,	1.0f, 1.0f,
			/** 11 */		-0.5f,0.5f,	0.5f,		1.0f, 1.0f, 1.0f,	0.0f, 1.0f,

			/** 12 */		-0.5f,-0.5f,-0.5f,		1.0f, 1.0f, 1.0f,	0.0f, 0.0f,
			/** 13 */		0.5f,-0.5f,	-0.5f,		1.0f, 1.0f, 1.0f,	1.0f, 0.0f,
			/** 14 */		0.5f,-0.5f,	0.5f,		1.0f, 1.0f, 1.0f,	1.0f, 1.0f,
			/** 15 */		-0.5f,-0.5f,0.5f,		1.0f, 1.0f, 1.0f,	0.0f, 1.0f,

			/** 16 */		0.5f,-0.5f,	-0.5f,		1.0f, 1.0f, 1.0f,	0.0f, 0.0f,
			/** 17 */		0.5f,-0.5f,	0.5f,		1.0f, 1.0f, 1.0f,	1.0f, 0.0f,
			/** 18 */		0.5f,0.5f,	0.5f,		1.0f, 1.0f, 1.0f,	1.0f, 1.0f,
			/** 19 */		0.5f,0.5f,	-0.5f,		1.0f, 1.0f, 1.0f,	0.0f, 1.0f,
			
			/** 20 */		-0.5f,-0.5f,-0.5f,		1.0f, 1.0f, 1.0f,	0.0f, 0.0f,
			/** 21 */		-0.5f,-0.5f,0.5f,		1.0f, 1.0f, 1.0f,	1.0f, 0.0f,
			/** 22 */		-0.5f,0.5f,	0.5f,		1.0f, 1.0f, 1.0f,	1.0f, 1.0f,
			/** 23 */		-0.5f,0.5f,	-0.5f,		1.0f, 1.0f, 1.0f,	0.0f, 1.0f
